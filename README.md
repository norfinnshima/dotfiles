...
* [Settings](https://github.com/norfinnshima/dotfiles/blob/main/sublimetext/settings/Preferences.sublime-settings)

## VSCode
* [全体の設定: vscode-user-settings.json](https://github.com/norfinnshima/dotfiles/blob/main/vscode/settings/vscode-user-settings.json)
* [エクスプローラーに表示しないファイルを指定する: vscode-workspace-settings.json](https://github.com/norfinnshima/dotfiles/blob/main/vscode/settings/vscode-workspace-settings.json)
